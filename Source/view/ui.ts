...
export class UI {
	 ...
	 */
	public static async openAndShowTextDocument(
		filePath: string,
	): Promise<void> {
	 ...
	 */
	public static async selectTemplateFile(
		label: string,
		folder: string,
	): Promise<string> {
		const files: string[] = Utility.listFile(
			folder,
	 ...
	 */
	public static async inputModelName(
		label: string,
		type: ModelType,
		folder: string,
	): Promise<string> {
